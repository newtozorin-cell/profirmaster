...
def load_token():
    """Load tokens from file on startup, with FYERS_ACCESS_TOKEN env var fallback"""
    try:
        ...
        print(f"⚠ No token file found - falling back to FYERS_ACCESS_TOKEN env var")
...
print("Keep-alive pinger started (only during market hours)")
